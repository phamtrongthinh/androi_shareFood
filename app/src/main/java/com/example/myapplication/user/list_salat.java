...
public class list_salat extends AppCompatActivity {
    GridView gridFood;
    ImageView imgBack;
    ArrayList<Food> list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_salat);
        ...
        gridFood = findViewById(R.id.grid_salat);
        imgBack = findViewById(R.id.img_listSalat_back);
        list = new ArrayList<>();
        adapter = new FoodAdapter(this, R.layout.row_food , list);
        gridFood.setAdapter(adapter);
        String sql_select = "select * from "+DBhelper.TB_FOOD+" where categoryid = 4";
    ...
    private void addAction() {
        gridFood.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(list_salat.this, user_detailFood.class);
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(list_salat.this, main_user.class);
                startActivity(intent);
            }
        });
    }

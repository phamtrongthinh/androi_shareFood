...
public class list_drink extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridDrink = findViewById(R.id.grid_drink);
        imgBack = findViewById(R.id.img_listDrink_back);
        list = new ArrayList<>();
        adapter = new FoodAdapter(this, R.layout.row_food , list);
        gridDrink.setAdapter(adapter);
        String sql_select = "select * from "+DBhelper.TB_FOOD+" where categoryid = 1";
    ...
    private void addAction() {
        gridDrink.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(list_drink.this, user_detailFood.class);
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(list_drink.this, main_user.class);
                startActivity(intent);
            }
        });
    }
